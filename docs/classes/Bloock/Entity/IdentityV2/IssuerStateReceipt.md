...
* Full name: `\Bloock\Entity\IdentityV2\IssuerStateReceipt`
...
```php
public static fromProto(\Bloock\IssuerStateReceipt $res): \Bloock\Entity\IdentityV2\IssuerStateReceipt
```
