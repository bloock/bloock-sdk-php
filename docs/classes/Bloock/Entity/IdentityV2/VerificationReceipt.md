...
* Full name: `\Bloock\Entity\IdentityV2\VerificationReceipt`
...
```php
public static fromProto(\Bloock\VerificationReceipt $res): \Bloock\Entity\IdentityV2\VerificationReceipt
```
