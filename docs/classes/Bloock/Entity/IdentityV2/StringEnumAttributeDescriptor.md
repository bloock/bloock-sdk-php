...
* Full name: `\Bloock\Entity\IdentityV2\StringEnumAttributeDescriptor`
...
```php
public static fromProto(\Bloock\StringEnumAttributeDefinitionV2 $res): \Bloock\Entity\IdentityV2\StringEnumAttributeDescriptor
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$res` | **\Bloock\StringEnumAttributeDefinitionV2** |  |
...
```php
public toProto(): \Bloock\StringEnumAttributeDefinitionV2
```
